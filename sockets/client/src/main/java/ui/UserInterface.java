...
public class UserInterface {
    ...
    public UserInterface(ExecutorService executorService,StudentControllerInterface studentService, LabProblemControllerInterface problemController, AssignmentControllerInterface assignmentController) {
    ...
    private void printAllStudents() {
        ...
        studentController.getAllStudents().thenAcceptAsync(students -> students.forEach(System.out::println));
    ...
    private void filterStudents() {
        ...
        studentController.filterStudentsByName("s2").thenAcceptAsync(students -> students.forEach(System.out::println));
    }
    ...
    private void sortStudents() {
        ...
        studentController.sortStudentsAscendingByName().thenAcceptAsync(students -> students.forEach(System.out::println));
    }
    ...
    private void addProblems() {
        while (true) {
            ...
            try {
                ...
                System.out.println("Problem couldn't be added");
                System.out.println(e.getMessage());
            }
        }
    }
    ...
    private void deleteProblems() {
        while (true) {
            ...
            try {
                ...
                System.out.println("Problem couldn't be deleted");
                System.out.println(e.getMessage());
            }
        }
    }
    ...
    private void updateProblems() {
        while (true) {
            ...
            try {
                ...
                System.out.println("Problem couldn't be updated");
                System.out.println(e.getMessage());
            }
        }
    }
    ...
    private void printAllProblems() {
        labProblemController.getAllProblems().thenAcceptAsync(p->p.forEach(System.out::println));
    }
    ...
    private void filterProblems() {
        ...
        labProblemController.filterProblemsByScore(5).thenAcceptAsync(p->p.forEach(System.out::println));
    }
    ...
    private void sortProblems() {
        ...
        labProblemController.sortProblemsDescendingByScore().thenAcceptAsync(p->p.forEach(System.out::println));
    }
    ...
    private void gradeAssignments() {
        while (true) {
            ...
            try {
                ...
                System.out.println("Assignment couldn't be graded");
                System.out.println(e.getMessage());
            }
        }
    }
    ...
    private void printAllAssignments() {
        this.assignmentController.getAllAssignments().thenAcceptAsync(assignments -> assignments.forEach(System.out::println));
    }
    ...
    private void filterAssignments() {
        ...
        this.assignmentController.filterAssignmentsByGrade(5).thenAcceptAsync(assignments -> assignments.forEach(System.out::println));
    }
    ...
    private void sortAssignments() {
        ...
        this.assignmentController.sortAssignmentsAscendingById().thenAcceptAsync(assignments -> assignments.forEach(System.out::println));
    }
    ...
    private void passingStudents() {
        ...
        studentController.getStudentsWhoPassed().thenAcceptAsync(students -> students.forEach(System.out::println));
    }
    ...
    private void mostAssignedProblem() {
        ...
        labProblemController.getProblemAssignedMostTimes().thenAcceptAsync(System.out::println);
    }
    ...
    private void studentMostAssignedProblems(){
        ...
        studentController.getStudentsWithMostProblems().thenAcceptAsync(System.out::println);
    }
}
