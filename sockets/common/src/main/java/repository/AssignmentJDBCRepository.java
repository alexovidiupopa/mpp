...
public class AssignmentJDBCRepository extends DatabaseRepository<Pair<Long,Long>, Assignment> {

    public AssignmentJDBCRepository(Validator<Assignment> validator, String dbCredentialsFilename) {
