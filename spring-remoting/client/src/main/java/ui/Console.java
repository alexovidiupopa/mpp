...
public class Console {
    ...
    public Console(StudentControllerInterface studentController, LabProblemControllerInterface problemController, AssignmentControllerInterface assignmentController) {
...
/*        Set<Student> students = studentController.getAllStudents();
    ...
    private void filterStudents() {
        ...
        students.forEach(System.out::println);*/
        CompletableFuture.supplyAsync(
                ()-> studentController.filterStudentsByName("s2")
        )
                .thenAcceptAsync(students -> students.forEach(System.out::println));
    }
    ...
    private void sortStudents() {
        ...
        students.forEach(System.out::println);*/
        CompletableFuture.supplyAsync(
                ()-> studentController.sortStudentsAscendingByName()
        )
                .thenAcceptAsync(students -> students.forEach(System.out::println));
    }
    ...
    private void printAllProblems() {
        ...
        CompletableFuture.supplyAsync(
                ()->labProblemController.getAllProblems()
        )
    ...
    private void filterProblems() {
        ...
        CompletableFuture.supplyAsync(
                ()->labProblemController.filterProblemsByScore(5)
        )
                .thenAcceptAsync(problems->problems.forEach(System.out::println));
    }
    ...
    private void sortProblems() {
        ...
        students.forEach(System.out::println);*/
        CompletableFuture.supplyAsync(
                ()-> labProblemController.sortProblemsDescendingByScore()
        )
                .thenAcceptAsync(problems->problems.forEach(System.out::println));
    }
    ...
    private void filterAssignments() {
        ...
        CompletableFuture.supplyAsync(
                ()->assignmentController.filterAssignmentsByGrade(5)
        )
                .thenAcceptAsync(assignments -> assignments.forEach(System.out::println));
    }
    ...
    private void sortAssignments() {
        ...
        students.forEach(System.out::println);*/
        CompletableFuture.supplyAsync(
                ()-> assignmentController.sortAssignmentsAscendingById()
        )
                .thenAcceptAsync(assignments -> assignments.forEach(System.out::println));
    }
    ...
    private void passingStudents() {
        ...
        students.forEach(System.out::println);*/
        CompletableFuture.supplyAsync(
                ()->studentController.getStudentsWhoPassed()
        )
                .thenAcceptAsync(students -> students.forEach(System.out::println));
    }
    ...
    private void mostAssignedProblem() {
        ...
        CompletableFuture.supplyAsync(
                ()-> {
                    try {
                        return labProblemController.getProblemAssignedMostTimes().toString();
                    } catch (MyException e) {
                        System.out.println(e.getMessage());
                    }
                    return null;
    ...
    private void studentMostAssignedProblems() {
        ...
        CompletableFuture.supplyAsync(
                ()-> {
                    try {
                        return studentController.getStudentsWithMostProblems().toString();
                    } catch (MyException e) {
                        System.out.println(e.getMessage());
                    }
                    return null;
